...
public:
	EllipseShape(CPoint, bool, int, ShapeType, COLORREF, COLORREF, int);
	void draw(CDC* dc);
...
public:
	RectangleShape(CPoint, bool, int, ShapeType, COLORREF, COLORREF, int);
	void draw(CDC* dc);
...
public:
	CPoint triangle[3];
	int test;
	TriangleShape(CPoint, bool, int, ShapeType, COLORREF, COLORREF, int);
	void draw(CDC* dc);
